...
function executeWidgetCode() {
	require(["UWA/Drivers/jQuery",
        ...
        "DSISWidgetModules/Connector3DExp",
        ...
        var myWidget = {
            ...
            onLoadWidget: function () {
                ...
                $wdgBody.html("<div id='divTable' style='height:100%;overflow-x:auto;overflow-y:hidden;'></div>"); //overflow:auto; removed with new line virtualization... Add it back for horizontal scrolling for large columns
                ...
                myWidget._prefSetFind.setupConfig("DSISFindPrefSet", [ //Array of Prefs to Save
                    {
                        name: "configNameFind",
                        noSave: true
                    },
                ...
                myWidget._prefSetExpand.setupConfig("DSISExpandPrefSet", [ //Array of Prefs to Save
                    {
                ...
                myWidget._prefSetDisplay.setupConfig("DSISDisplayPrefSet", [ //Array of Prefs to Save
                    {
